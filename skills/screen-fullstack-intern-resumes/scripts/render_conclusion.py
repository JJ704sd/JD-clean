#!/usr/bin/env python3
"""Render validated full-stack intern screening records as concise recruiter conclusions."""
...
CRITERION_LABELS = {
    ...
    "INT-AVAIL-01": "每周可用性",
    "INT-BE-01": "后端实现",
    "INT-WEB-01": "HTTP/REST",
    "INT-FE-01": "前端基础",
    "INT-DATA-01": "数据库/SQL",
    "INT-PROJECT-01": "完整项目",
    "INT-QUALITY-01": "工程习惯",
    "INT-AI-01": "AI 学习潜力",
    "INT-DOMAIN-01": "物流/电商领域",
}
EVIDENCE_PRIORITY = {
    criterion: index
...
def _load_validator():
    ...
    spec = importlib.util.spec_from_file_location("intern_screening_validator", path)
